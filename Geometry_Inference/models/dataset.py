...
import numpy as np
from models.utils import render_feature_as_tex, split_number, createMeshSequenceTensorByList, gen_uv_barycentric, dilate_barycentric_maps
...
class SurfaceFinetuneDataset(Dataset):
    ...
    def __getitem__(self, index):
        current_frame_id = self.chosen_frame_id_list[(index % len(self.chosen_frame_id_list))]
